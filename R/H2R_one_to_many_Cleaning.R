...
setwd("~/Desktop/Nigeria/Hard_to_reach/Data_Cleaning")

#UNLCEANED DATA == "CSV" OR "EXCEL"
uncleaned_data_file_type <- "EXCEL"

#IMPORT FOLDERS
cleaning_log_import_folder <- "H2R_data"  #FOLDER WHERE THE CLEANING LOG IS STORED
cleaning_name <- "H2R_CLEANING_LOG"  #NAME OF EXCEL/CSV FILE WHERE CLEANING LOG IS STORED
